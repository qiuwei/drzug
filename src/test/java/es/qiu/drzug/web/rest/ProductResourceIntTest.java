...
public class ProductResourceIntTest {
    ...
    private static final BigDecimal DEFAULT_SUGGESTED_PRICE = new BigDecimal(1);
    private static final BigDecimal UPDATED_SUGGESTED_PRICE = new BigDecimal(2);

    private static final ProductType DEFAULT_TYPE = ProductType.SERVICE;
    private static final ProductType UPDATED_TYPE = ProductType.PRODUCT;
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getSuggestedPrice()).isEqualTo(DEFAULT_SUGGESTED_PRICE);
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getSuggestedPrice()).isEqualTo(UPDATED_SUGGESTED_PRICE);
