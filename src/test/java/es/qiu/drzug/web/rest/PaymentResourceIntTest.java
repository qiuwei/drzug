...
public class PaymentResourceIntTest {
    ...
    private static final Unit DEFAULT_UNIT = Unit.CNY;
    private static final Unit UPDATED_UNIT = Unit.EURO;
    ...
    public void createPayment() throws Exception {
        ...
        assertThat(testPayment.getUnit()).isEqualTo(DEFAULT_UNIT);
    }
    ...
    public void updatePayment() throws Exception {
        ...
        assertThat(testPayment.getUnit()).isEqualTo(UPDATED_UNIT);
    }
