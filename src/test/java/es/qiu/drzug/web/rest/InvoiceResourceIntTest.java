...
public class InvoiceResourceIntTest {
    ...
    private static final InvoiceStatus DEFAULT_STATUS = InvoiceStatus.OPEN;
    ...
    public void createInvoice() throws Exception {
        ...
        assertThat(testInvoice.getCreateAt()).isEqualTo(DEFAULT_CREATE_AT);
    ...
    public void updateInvoice() throws Exception {
        ...
        Invoice testInvoice = invoiceList.get(invoiceList.size() - 1);
        assertThat(testInvoice.getCreateAt()).isEqualTo(UPDATED_CREATE_AT);
